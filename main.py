...
parser = argparse.ArgumentParser(
    description="Extract code context for a specific target from a given repository."
)
...
if __name__ == "__main__":
    if not all([TARGET, VENV_PATH, OUTPUT_FILE, REPO_PATH]):
        print(
            "All parameters are required. Provide them through command line or .env file."
        )
    else:
